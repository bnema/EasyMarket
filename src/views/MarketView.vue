<template>
    ...
    <!-- Compare with previousFetch to list items that have been added in the last 10 minutes -->
<ul v-for="store in Stores">
  <li>{{ store.Name }}</li>
  <ul>
    <li v-for="offer in getDifference(previousFetch[previousFetch.length - 1], store).AllOffers">
